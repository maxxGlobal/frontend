...
export default function CartPage() {
  ...
  // ✅ YENİ: Sipariş notu state'i
  const [orderNotes, setOrderNotes] = useState<string>("");
  const [notesCharCount, setNotesCharCount] = useState(0);
  const MAX_NOTES_LENGTH = 500; // Maksimum karakter sayısı
  ...
  const createOrderRequest = (
    ...
    return {
      ...
      notes: orderNotes.trim() || undefined, // ✅ Kullanıcının girdiği notu ekle
    };
  };
        ...
        <div className="cart-page-wrapper w-full bg-white pb-[60px]">
          ...
          <div className="w-full mt-[23px]">
            <div className="container-x mx-auto">
              ...
              {/* Sipariş Notu */}
              <div className="mb-6">
                <h2 className="text-lg font-semibold mb-3">Sipariş Notu</h2>
                <div className="relative">
                  <textarea
                    value={orderNotes}
                    onChange={handleNotesChange}
                    placeholder="Siparişiniz ile ilgili eklemek istediğiniz notlar... (İsteğe bağlı)"
                    className="w-full p-4 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-qh2-green focus:border-transparent"
                    rows={4}
