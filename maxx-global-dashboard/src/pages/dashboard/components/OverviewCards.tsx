// src/pages/dashboard/components/OverviewCards.tsx
...
export default function OverviewCards() {
  ...
  useEffect(() => {
    getDashboardOverview().then(setData).catch(console.error);
  }, []);
  ...
  return (
    <>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30 d-block">
          ...
          <div className="sherah-progress-card__content">
            <h3 className="sherah-progress-card__title fs-4">
              Toplam Kullanıcı
            </h3>
            <p className="sherah-progress-card__number fs-4 text-primary">
              {data.totalUsers}
            </p>
          </div>
          <div className="mt-3">
            <a href="/users/list" className="sherah-see-all text-primary">
      ...
      <div className="col-lg-3 col-md-6 col-12">
        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30 d-block">
          ...
          <div className="sherah-progress-card__content">
            <h4 className="sherah-progress-card__title fs-4">Toplam Sipariş</h4>
            <p className="sherah-progress-card__number fs-4 text-success">
              {data.totalOrders}
            </p>
          </div>
          <div className="mt-3">
            <a href="/orders-list" className="sherah-see-all text-success">
      ...
      <div className="col-lg-3 col-md-6 col-12">
        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30 d-block">
          ...
          <div className="sherah-progress-card__content">
            <h4 className="sherah-progress-card__title fs-4">Toplam Bayi</h4>
            <p className="sherah-progress-card__number fs-4 text-warning">
              {data.totalDealers}
            </p>
          </div>
          <div className="mt-3">
            <a href="/dealers" className="sherah-see-all text-warning">
      ...
      <div className="col-lg-3 col-md-6 col-12">
        <div className="sherah-progress-card sherah-border sherah-default-bg mg-top-30 d-block">
          ...
          <div className="sherah-progress-card__content">
            <h4 className="sherah-progress-card__title fs-4">Toplam Ürün</h4>
            <p className="sherah-progress-card__number fs-4 text-danger">
              {data.totalDealers}
            </p>
          </div>
          <div className="mt-3">
            <a href="/product" className="sherah-see-all text-danger">
