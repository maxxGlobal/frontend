...
export default function DailySummary() {
    ...
    const { data: summary, isLoading, error } = useQuery<DailySummaryResponse>({
                ...
                <>
                    <div className="row mg-top-30">
                        <div className="col-12">
                            <h4 className="mb-3">{formatDate(summary.date)} Tarihli Özet</h4>
                        </div>
                    </div>
                    ...
                    <div className="row mg-top-20">
                        ...
                        <div className="col-xxl-3 col-lg-6 col-md-6 col-12">
                            <div className="sherah-overview__single sherah-default-bg sherah-border">
                                <div className="sherah-overview__single--inner">
                                    <div className="sherah-overview__single--count">
                                        <h3 className="sherah-overview__single--title">{summary.totalMovements}</h3>
                                        <p className="sherah-overview__single--text">Toplam Hareket</p>
                                    </div>
                                    <div className="sherah-overview__single--icon sherah-color1__bg">
                        ...
                        <div className="col-xxl-3 col-lg-6 col-md-6 col-12">
                            <div className="sherah-overview__single sherah-default-bg sherah-border">
                                <div className="sherah-overview__single--inner">
                                    <div className="sherah-overview__single--count">
                                        <h3 className="sherah-overview__single--title text-success">+{summary.totalStockIn}</h3>
                                        <p className="sherah-overview__single--text">Toplam Giriş</p>
                                    </div>
                                    <div className="sherah-overview__single--icon sherah-color3__bg">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className="col-xxl-3 col-lg-6 col-md-6 col-12">
                            <div className="sherah-overview__single sherah-default-bg sherah-border">
                                <div className="sherah-overview__single--inner">
                                    <div className="sherah-overview__single--count">
                                        <h3 className="sherah-overview__single--title text-danger">-{summary.totalStockOut}</h3>
                                        <p className="sherah-overview__single--text">Toplam Çıkış</p>
                                    </div>
                                    <div className="sherah-overview__single--icon sherah-color2__bg">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className="col-xxl-3 col-lg-6 col-md-6 col-12">
                            <div className="sherah-overview__single sherah-default-bg sherah-border">
                                <div className="sherah-overview__single--inner">
                                    <div className="sherah-overview__single--count">
                                        <h3 className={`sherah-overview__single--title ${summary.netChange >= 0 ? 'text-success' : 'text-danger'
                                            }`}>
                                            {summary.netChange >= 0 ? '+' : ''}{summary.netChange}
                                        </h3>
                                        <p className="sherah-overview__single--text">Net Değişim</p>
                                    </div>
                                    <div className={`sherah-overview__single--icon ${summary.netChange >= 0 ? 'sherah-color3__bg' : 'sherah-color2__bg'
                                        }`}>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path d="M22 12H2M15 5L22 12L15 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-4">
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="mb-3">
                                        <strong>Toplam Hareket Sayısı:</strong> {summary.totalMovements}
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <strong>Giriş/Çıkış Oranı:</strong> {
                                            summary.totalStockOut > 0
                                                ? (summary.totalStockIn / summary.totalStockOut).toFixed(2)
                                                : 'N/A'
                                        }
                                    </div>
                                    <div className="mb-3">
                                        <strong>Hareket Durumu:</strong>
                                        <span className={`ms-2 badge ${summary.netChange > 0 ? 'bg-success' :
                                                summary.netChange < 0 ? 'bg-danger' : 'bg-secondary'
                                            }`}>
                                            {summary.netChange > 0 ? 'Artış' :
                                                summary.netChange < 0 ? 'Azalış' : 'Değişim Yok'}
                                        </span>
                                    </div>
                                </div>
                            </div>
