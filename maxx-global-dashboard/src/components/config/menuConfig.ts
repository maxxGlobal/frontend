...
<svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="19.527" height="19.582" viewBox="0 0 19.527 19.582">
											<g id="Icon" transform="translate(-115.401 35.25)">
											  ...
											  <path id="Path_1027" data-name="Path 1027" d="M262.772,101.242q2.084,0,4.168,0a.572.572,0,0,1,.572.789.554.554,0,0,1-.539.357c-.376,0-.752,0-1.128,0h-7.151a1.177,1.177,0,0,1-.247-.014.572.572,0,0,1,.138-1.132q1.941,0,3.881,0Z" transform="translate(-135.313 -129.532)"></path>
											  <path id="Path_1028" data-name="Path 1028" d="M206.635,193.557c.317,0,.609,0,.9,0a.576.576,0,1,1,0,1.147q-.708,0-1.415,0a.58.58,0,0,1-.631-.63q0-1.09,0-2.181a.576.576,0,1,1,1.147-.006C206.636,192.435,206.635,192.983,206.635,193.557Z" transform="translate(-85.488 -214.962)"></path>
											</g>
										</svg>
`;
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    // ✅ SYSTEM_ADMIN veya USER_READ/USER_MANAGE yetkisi olanlara göster
    ...
    children: [
      ...
      },
      {
        ...
        to: "/users/register",
        anyOf: ["SYSTEM_ADMIN", "USER_MANAGE"],
      },
    ],
  },
  {
    ...
    anyOf: ["SYSTEM_ADMIN"], // Sadece SYSTEM_ADMIN görebilir
    children: [
      {
        id: "rol_add",
        label: "Rol Ekle",
  ...
  {
    id: "menu-item__discounts",
    label: "İndirimler",
    iconHtml: DiscountsIconHTML,
    anyOf: ["SYSTEM_ADMIN"],
    children: [
      {
        id: "discounts-create",
  ...
  },
  {
    ...
    label: "Bildirimler",
    iconHtml: NotifivationsIconHTML,
    anyOf: ["SYSTEM_ADMIN"],
    children: [
      {
